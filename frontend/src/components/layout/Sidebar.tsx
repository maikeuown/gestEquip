...
const navItems = [
  ...
  { href: '/requests', icon: ClipboardList, label: 'Pedidos', roles: ['SUPER_ADMIN', 'ADMIN', 'STAFF'] },
  { href: '/rooms', icon: DoorOpen, label: 'Salas', roles: ['SUPER_ADMIN', 'ADMIN', 'TECHNICIAN', 'STAFF'] },
  { href: '/rooms-teacher', icon: DoorOpen, label: 'Salas', roles: ['TEACHER'] },
  { href: '/schedules', icon: Monitor, label: 'Horários', roles: ['SUPER_ADMIN', 'ADMIN', 'TEACHER', 'STAFF'] },
